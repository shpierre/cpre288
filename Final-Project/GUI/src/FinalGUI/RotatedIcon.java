...
/**
 *  The RoombaGUI.RotatedIcon allows you to change the orientation of an Icon by
...
public class RotatedIcon implements Icon
{
    ...
    /**
     *  Convenience constructor to create a RoombaGUI.RotatedIcon that is rotated DOWN.
     *
    ...
    /**
     *  Create a RoombaGUI.RotatedIcon
     *
     *  @param icon	the Icon to rotate
    ...
    /**
     *  Create a RoombaGUI.RotatedIcon. The icon will rotate about its center. This
     ...
     *  When true, the icon width/height will not change as the Icon is rotated.
     *
     //         *  @param  for a circular Icon, false otherwise
     */
